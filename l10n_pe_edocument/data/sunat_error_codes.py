SUNAT_ERROR_CODES = {
    ...
    '0101': 'El encabezado de seguridad es incorrecto', '0102': 'Usuario o contraseña incorrectos', '0103': 'El Usuario ingresado no existe',
    '0104': 'La Clave ingresada es incorrecta', '0105': 'El Usuario no está activo', '0106': 'El Usuario no es válido',
    '0109': 'El sistema no puede responder su solicitud. (El servicio de autenticación no está disponible)',
    '0110': 'No se pudo obtener la informacion del tipo de usuario', '0111': 'No tiene el perfil para enviar comprobantes electronicos',
    '0112': 'El usuario debe ser secundario', '0113': 'El usuario no esta afiliado a Factura Electronica',
    '0125': 'No se pudo obtener la constancia', '0126': 'El ticket no le pertenece al usuario', '0127': 'El ticket no existe',
    ...
    '0138': 'El sistema no puede responder su solicitud. (Error en Base de Datos)', '0151': 'El nombre del archivo ZIP es incorrecto',
    '0152': 'No se puede enviar por este método un archivo de resumen', '0153': 'No se puede enviar por este método un archivo por lotes',
    ...
    '0155': 'El archivo ZIP esta vacio', '0156': 'El archivo ZIP esta corrupto', '0157': 'El archivo ZIP no contiene comprobantes',
    '0158': 'El archivo ZIP contiene demasiados comprobantes para este tipo de envío', '0159': 'El nombre del archivo XML es incorrecto',
    '0160': 'El archivo XML esta vacio', '0161': 'El nombre del archivo XML no coincide con el nombre del archivo ZIP',
    ...
    '0253': 'No se pudo procesar su solicitud. (No se pudo comprimir la constancia)', '0300': 'No se encontró la raíz documento xml',
    '0301': 'Elemento raiz del xml no esta definido', '0302': 'Codigo del tipo de comprobante no registrado',
    '0303': 'No existe el directorio de schemas', '0304': 'No existe el archivo de schema',
    '0305': 'El sistema no puede procesar el archivo xml', '0306': 'No se puede leer (parsear) el archivo XML',
    '0307': 'No se pudo recuperar la constancia', '0400': 'No tiene permiso para enviar casos de pruebas',
    '0401': 'El caso de prueba no existe', '0402': 'La numeracion o nombre del documento ya ha sido enviado anteriormente',
    '0403': 'El documento afectado por la nota no existe', '0404': 'El documento afectado por la nota se encuentra rechazado',
    ...
    '1009': 'IssueDate - El dato ingresado  no cumple con el patron YYYY-MM-DD', '1010': 'El XML no contiene el tag IssueDate',
    '1011': 'IssueDate- El dato ingresado no es valido', '1012': 'ID - El dato ingresado no cumple con el patron SERIE-CORRELATIVO',
    '1013': 'El XML no contiene informacion en el tag ID', '1014': 'CustomerAssignedAccountID - El dato ingresado no cumple con el estandar',
    ...
    '1018': 'IssueDate - El dato ingresado no cumple con el patron YYYY-MM-DD', '1019': 'El XML no contiene el tag IssueDate',
    '1020': 'IssueDate- El dato ingresado no es valido', '1021': 'Error en la validacion de la nota de credito',
    ...
    '1028': 'IssueDate - El dato ingresado no cumple con el patron YYYY-MM-DD', '1029': 'El XML no contiene el tag IssueDate',
    '1030': 'IssueDate- El dato ingresado no es valido', '1031': 'Error en la validacion de la nota de debito',
    ...
    '1072': 'Starttime - El dato ingresado  no cumple con el patron HH:mm:ss.SZ.', '1073': 'StartTime - El dato ingresado no es valido.',
    ...
    '2104': 'Numero de RUC del emisor no existe', '2010': 'El contribuyente no esta activo', '2011': 'El contribuyente no esta habido',
    ...
    '2028': 'Debe existir el tag cac:AlternativeConditionPrice', '2029': 'PriceTypeCode El dato ingresado no cumple con el estandar',
    '2030': 'El XML no contiene el tag cbc:PriceTypeCode', '2031': 'El dato ingresado en total valor de venta no cumple con el estandar',
    '2032': 'El XML no contiene el tag LineExtensionAmount en el detalle de los Items',
    '2033': 'El dato ingresado en TaxAmount de la linea no cumple con el formato establecido', '2034': 'TaxAmount es obligatorio',
    '2035': 'cac:TaxCategory/cac:TaxScheme/cbc:ID El dato ingresado no cumple con el estandar', '2036': 'El codigo del tributo es invalido',
    ...
    '2040': 'El tipo de afectacion del IGV es incorrecto', '2041': 'El sistema de calculo del ISC es incorrecto',
    '2042': 'Debe indicar el IGV. Es un campo obligatorio', '2043': 'El dato ingresado en PayableAmount no cumple con el formato establecido',
    '2044': 'PayableAmount es obligatorio', '2045': 'El valor ingresado en AdditionalMonetaryTotal/cbc:ID es incorrecto',
    ...
    '2048': 'El dato ingresado en TaxAmount no cumple con el formato establecido', '2049': 'TaxAmount es obligatorio',
    '2050': 'TaxScheme ID - No existe el tag o el dato ingresado no cumple con el estandar', '2051': 'El codigo del tributo es invalido',
    ...
    '2062': 'El dato ingresado en PayableAmount no cumple con el formato establecido', '2063': 'El XML no contiene el tag PayableAmount',
    ...
    '2072': 'CustomizationID - La versión del documento no es la correcta', '2073': 'El XML no existe informacion de CustomizationID',
    '2074': 'UBLVersionID - La versión del UBL no es correcta', '2075': 'El XML no contiene el tag o no existe informacion de UBLVersionID',
    '2076': 'cac:Signature/cbc:ID - Falta el identificador de la firma', '2077': 'El tag cac:Signature/cbc:ID debe contener informacion',
    ...
    '2102': 'Error al procesar la factura', '2103': 'La serie ingresada no es válida',
    '2105': 'Comprobante a dar de baja no se encuentra registrado en SUNAT',
    '2106': 'Factura a dar de baja ya se encuentra en estado de baja', '2107': 'Numero de RUC SOL no coincide con RUC emisor',
    '2108': 'Presentacion fuera de fecha', '2109': 'El comprobante fue registrado previamente con otros datos',
    '2110': 'UBLVersionID - La versión del UBL no es correcta', '2111': 'El XML no contiene el tag o no existe informacion de UBLVersionID',
    ...
    '2139': 'CreditedQuantity - El dato ingresado no cumple con el estandar', '2140': 'El PriceTypeCode debe tener el valor 01',
    '2141': 'cac:TaxCategory/cac:TaxScheme/cbc:ID - El dato ingresado no cumple con el estandar', '2142': 'El codigo del tributo es invalido',
    ...
    '2145': 'El tipo de afectacion del IGV es incorrecto', '2146': 'El Nombre Internacional debe ser VAT',
    '2147': 'El sistema de calculo del ISC es incorrecto', '2148': 'El Nombre Internacional debe ser EXC',
    '2149': 'El dato ingresado en PayableAmount no cumple con el formato establecido',
    '2150': 'El valor ingresado en AdditionalMonetaryTotal/cbc:ID es incorrecto', '2151': 'AdditionalMonetaryTotal/cbc:ID debe tener valor',
    '2152': 'Es obligatorio al menos un AdditionalInformation', '2153': 'Error al procesar la Nota de Credito',
    '2154': 'TaxAmount - El dato ingresado en impuestos globales no cumple con el estandar',
    '2155': 'El XML no contiene el tag TaxAmount de impuestos globales', '2156': 'TaxScheme ID - El dato ingresado no cumple con el estandar',
    ...
    '2163': 'UBLVersionID - La versión del UBL no es correcta', '2164': 'El XML no contiene el tag o no existe informacion de UBLVersionID',
    '2165': 'Error al procesar la Nota de Debito', '2166': 'RegistrationName - El dato ingresado no cumple con el estandar',
    ...
    '2182': 'TaxScheme ID - El dato ingresado no cumple con el estandar', '2183': 'El codigo del tributo es invalido',
    ...
    '2193': 'cac:TaxCategory/cac:TaxScheme/cbc:ID El dato ingresado no cumple con el estandar', '2194': 'El codigo del tributo es invalido',
    ...
    '2197': 'El tipo de afectacion del IGV es incorrecto', '2198': 'El Nombre Internacional debe ser VAT',
    '2199': 'El sistema de calculo del ISC es incorrecto', '2200': 'El Nombre Internacional debe ser EXC',
    ...
    '2210': 'El dato ingresado no cumple con el formato RC-fecha-correlativo', '2211': 'El XML no contiene el tag ID',
    '2212': 'UBLVersionID - La versión del UBL del resumen de boletas no es correcta', '2213': 'El XML no contiene el tag UBLVersionID',
    '2214': 'CustomizationID - La versión del resumen de boletas no es correcta', '2215': 'El XML no contiene el tag CustomizationID',
    ...
    '2220': 'El ID debe coincidir con el nombre del archivo', '2221': 'El RUC debe coincidir con el RUC del nombre del archivo',
    '2222': 'El contribuyente no está autorizado a emitir comprobantes electronicos', '2223': 'El archivo ya fue presentado anteriormente',
    '2224': 'Numero de RUC SOL no coincide con RUC emisor', '2225': 'Numero de RUC del emisor no existe',
    '2226': 'El contribuyente no esta activo', '2227': 'El contribuyente no cumple con tipo de empresa o tributos requeridos',
    ...
    '2230': 'IssueDate - El dato ingresado no cumple con el patron YYYY-MM-DD', '2231': 'El XML no contiene el tag IssueDate',
    '2232': 'IssueDate- El dato ingresado no es valido', '2233': 'ReferenceDate - El dato ingresado no cumple con el patron YYYY-MM-DD',
    '2234': 'El XML no contiene el tag ReferenceDate', '2235': 'ReferenceDate- El dato ingresado no es valido',
    '2236': 'La fecha del IssueDate no debe ser mayor a la fecha de recepción',
    '2237': 'La fecha del ReferenceDate no debe ser mayor al Today', '2238': 'LineID - El dato ingresado no cumple con el estandar',
    ...
    '2241': 'DocumentTypeCode - El valor del tipo de documento es invalido', '2242': 'El XML no contiene el tag DocumentTypeCode',
    '2243': 'El dato ingresado  no cumple con el patron SERIE', '2244': 'El XML no contiene el tag DocumentSerialID',
    '2245': 'El dato ingresado en StartDocumentNumberID debe ser numerico', '2246': 'El XML no contiene el tag StartDocumentNumberID',
    '2247': 'El dato ingresado en sac:EndDocumentNumberID debe ser numerico', '2248': 'El XML no contiene el tag sac:EndDocumentNumberID',
    ...
    '2251': 'El dato ingresado en TotalAmount debe ser numerico mayor o igual a cero', '2252': 'El XML no contiene el tag TotalAmount',
    '2253': 'El dato ingresado en TotalAmount debe ser numerico mayor a cero',
    '2254': 'PaidAmount - El dato ingresado no cumple con el estandar', '2255': 'El XML no contiene el tag PaidAmount',
    '2256': 'InstructionID - El dato ingresado no cumple con el estandar', '2257': 'El XML no contiene el tag InstructionID',
    ...
    '2261': 'cbc:Amount - El dato ingresado no cumple con el estandar', '2262': 'El XML no contiene el tag cbc:Amount',
    '2263': 'ChargeIndicator - El dato ingresado no cumple con el estandar', '2264': 'El XML no contiene el tag ChargeIndicator',
    '2265': 'Debe indicar Información acerca del Importe Total de Otros Cargos', '2266': 'Debe indicar cargos mayores o iguales a cero',
    '2267': 'TaxScheme ID - El dato ingresado no cumple con el estandar', '2268': 'El codigo del tributo es invalido',
    '2269': 'El XML no contiene el tag TaxScheme ID de Información acerca del importe total de un tipo particular de impuesto',
    '2270': 'TaxScheme Name - El dato ingresado no cumple con el estandar', '2271': 'El XML no contiene el tag TaxScheme Name de impuesto',
    '2272': 'TaxScheme TaxTypeCode - El dato ingresado no cumple con el estandar',
    '2273': 'TaxAmount - El dato ingresado no cumple con el estandar', '2274': 'El XML no contiene el tag TaxAmount',
    ...
    '2278': 'Debe indicar Información acerca del importe total de IGV/IVAP', '2279': 'Debe indicar Items de consolidado de documentos',
    '2280': 'Existen problemas con la informacion del resumen de comprobantes',
    '2281': 'Error en la validacion de los rangos de los comprobantes', '2282': 'Existe documento ya informado anteriormente',
    '2283': 'El dato ingresado no cumple con el formato RA-fecha-correlativo', '2284': 'El tag ID esta vacío',
    '2285': 'El ID debe coincidir  con el nombre del archivo', '2286': 'El RUC debe coincidir con el RUC del nombre del archivo',
    ...
    '2291': 'El contribuyente no esta autorizado a emitir comprobantes electronicos', '2292': 'Numero de RUC SOL no coincide con RUC emisor',
    '2293': 'Numero de RUC del emisor no existe', '2294': 'El contribuyente no esta activo',
    ...
    '2298': 'IssueDate - El dato ingresado no cumple con el patron YYYY-MM-DD', '2299': 'El XML no contiene el tag IssueDate',
    '2300': 'IssueDate - El dato ingresado no es valido', '2301': 'La fecha del IssueDate no debe ser mayor a la fecha de recepción',
    '2302': 'ReferenceDate - El dato ingresado no cumple con el patron YYYY-MM-DD', '2303': 'El XML no contiene el tag ReferenceDate',
    '2304': 'ReferenceDate - El dato ingresado no es valido', '2305': 'LineID - El dato ingresado no cumple con el estandar',
    '2306': 'LineID - El dato ingresado debe ser correlativo mayor a cero', '2307': 'El tag LineID de VoidedDocumentsLine esta vacío',
    '2308': 'DocumentTypeCode - El valor del tipo de documento es invalido', '2309': 'El tag DocumentTypeCode es vacío',
    '2310': 'El dato ingresado  no cumple con el patron SERIE', '2311': 'El tag DocumentSerialID es vacío',
    '2312': 'El dato ingresado en DocumentNumberID debe ser numerico y como maximo de 8 digitos',
    '2313': 'El tag DocumentNumberID esta vacío', '2314': 'El dato ingresado en VoidReasonDescription debe contener información válida',
    '2316': 'Debe indicar Items en VoidedDocumentsLine',
    '2317': 'Error al procesar el resumen de anulados', '2318': 'CustomizationID - La version del documento no es correcta',
    '2319': 'El XML no contiene el tag CustomizationID', '2320': 'UBLVersionID - La version del UBL  no es la correcta',
    '2321': 'El XML no contiene el tag UBLVersionID', '2322': 'Error en la validacion de los rangos',
    '2323': 'Existe documento ya informado anteriormente en una comunicacion de baja',
    '2324': 'El archivo de comunicacion de baja ya fue presentado anteriormente', '2325': 'El certificado usado no es el comunicado a SUNAT',
    '2326': 'El certificado usado se encuentra de baja', '2327': 'El certificado usado no se encuentra vigente',
    '2328': 'El certificado usado se encuentra revocado', '2329': 'La fecha de emision se encuentra fuera del limite permitido',
    ...
    '2334': 'El documento electrónico ingresado ha sido alterado', '2335': 'El documento electrónico ingresado ha sido alterado',
    '2336': 'Ocurrió un error en el proceso de validación de la firma digital', '2337': 'La moneda debe ser la misma en todo el documento',
    ...
    '2340': 'El valor ingresado en AdditionalMonetaryTotal/cbc:ID es incorrecto', '2341': 'AdditionalMonetaryTotal/cbc:ID debe tener valor',
    ...
    '2344': 'El XML no contiene el tag cac:TaxTotal/cac:TaxSubtotal/cbc:TaxAmount', '2345': 'La serie no corresponde al tipo de comprobante',
    ...
    '2397': 'El tipo de documento del adquiriente no puede ser Numero de RUC', '2398': 'El documento a dar de baja se encuentra rechazado',
    ...
    '2401': 'No se puede leer (parsear) el archivo XML', '2402': 'El caso de prueba no existe',
    ...
    '2426': 'Documentos relacionados duplicados en el comprobante.', '2427': 'Solo debe de existir un tag AdditionalInformation.',
    ...
    '2500': 'Ingresar descripción y valor venta por ítem para documento de anticipos.', '2501': 'Valor venta debe ser mayor a cero.',
    ...
    '2504': 'Falta referencia de la factura relacionada con anticipo.', '2505': 'Código de documento de referencia debe ser 02 o 03.',
    '2506': 'cac:PrepaidPayment/cbc:ID: Factura o boleta no existe o comunicada de Baja.',
    '2507': 'Factura relacionada con anticipo no corresponde como factura de anticipo.', '2508': 'Ingresar documentos por anticipos.',
    '2509': 'Total de anticipos diferente a los montos anticipados por documento.',
    '2510': 'Nro nombre del documento no tiene el formato correcto.', '2511': 'El tipo de documento no es aceptado.',
    '2512': 'No existe información de serie o número.', '2513': 'Dato no cumple con formato de acuerdo al tipo de documento',
    '2514': 'No existe información de receptor de documento.', '2515': 'Dato ingresado no cumple con catalogo 6.',
    '2516': 'Debe indicar tipo de documento.', '2517': 'Dato no cumple con formato establecido.', '2518': 'Calculo IGV no es correcto.',
    ...
    '2524': 'Debe indicar el documento afectado por la nota', '2525': 'El dato ingresado en Quantity no cumple con el formato establecido.',
    ...
    '2529': 'RUC que emitio documento de anticipo, no existe.', '2530': 'RUC que solicita la emision de la factura, no existe.',
    '2531': 'Codigo del Local Anexo del emisor no existe.', '2532': 'No existe información de modalidad de transporte.',
    ...
    '2539': 'El contribuyente no esta activo.', '2540': 'El contribuyente no esta habido.',
    ...
    '2547': 'El XML no contiene el tag o no existe información del país en domicilio fiscal.', '2548': 'El valor del país inválido.',
    ...
    '2555': 'Destinatario no debe ser igual al remitente.', '2556': 'cbc:TransportModeCode -  dato ingresado no es valido.',
    ...
    '2583': 'Debe consignar tipo de documento que modifica', '2600': 'El comprobante fue enviado fuera del plazo permitido.',
    ...
    '2604': 'El Cliente no puede ser el mismo que el Emisor del comprobante de percepción.', '2605': 'Número de RUC no existe.',
    ...
    '2662': 'El Nro. de documento ya fué utilizado en la emision de CRE.', '2663': 'El documento indicado no existe no puede ser modificado',
    ...
    '2708': 'El XML no contiene el tag o no existe información de la Fecha de Percepción', '2709': 'La fecha de percepción no es válido',
    ...
    '2716': 'El dato ingresado en el tipo de cambio debe ser numérico mayor a cero', '2717': 'La fecha de cambio no es válido',
    ...
    '2743': 'El XML no contiene el tag o no existe información de la Fecha de Retención', '2744': 'La fecha de retención no es válido',
    ...
    '2750': 'El comprobante que desea revertir no existe.', '2751': 'El comprobante fue informado previamente en una reversión.',
    '2752': 'El número de ítem no puede estar duplicado.', '2753': 'No debe existir mas de una referencia en guía dada de baja.',
    ...
    '2787': 'Debe consignar la moneda para la Base imponible percepcion.', '2788': 'El dato ingresado en moneda debe ser PEN',
    ...
    '2805': 'El XML no contiene el tag IssueTime', '2806': 'IssueTime - El dato ingresado  no cumple con el patrón hh:mm:ss.sssss',
    '2807': 'El XML no contiene el tag ResponseDate', '2808': 'ResponseDate - El dato ingresado  no cumple con el patrón YYYY-MM-DD',
    ...
    '2811': 'El XML no contiene el tag ResponseTime', '2812': 'ResponseTime - El dato ingresado  no cumple con el patrón hh:mm:ss.sssss',
    ...
    '2883': 'Es obligatorio indicar la unidad de medida del ítem', '2891': 'La tasa de percepción no existe en el catálogo',
    ...
    '2921': 'Es obligatorio informar el detalle el tipo de servicio público', '2922': 'El valor del Tag no se encuentra en el catálogo',
    '2923': 'Es obligatorio informar el código de servicios de telecomunicaciones para el tipo servicio público informado',
    '2924': 'Sólo enviar información para el tipos de servicios públicos 5', '2925': 'El valor del Tag no se encuentra en el catálogo',
    ...
    '2933': 'Sólo enviar información para el tipos de servicios públicos 1 o 2', '2934': 'El valor del Tag no se encuentra en el catálogo',
    '2935': 'Es obligatorio informar la unidad de medida', '2936': 'El dato ingresado como unidad de medida no corresponde al valor esperado',
    ...
    '2939': 'El valor del Tag no cumple con el tipo y longitud esperada', '2940': 'Es obligatorio informar el tipo de medidor',
    '2941': 'Sólo enviar información para el tipo de servicios público 1', '2942': 'El valor del Tag no se encuentra en el catálogo',
    '2943': 'Es obligatorio informar el número del medidor', '2944': 'Sólo enviar información para el tipos de servicios públicos 1 o 2',
    '2945': 'El valor del Tag no cumple con el tipo y longitud esperada', '2946': 'Debe informar el consumo del periodo',
    '2947': 'No existe el detalle del número del medidor', '2948': 'Sólo enviar información para el tipos de servicios públicos 1 o 2',
    '2949': 'El impuesto ICBPER no se encuentra vigente', '2950': 'El comprobante ha sido presentado fuera de plazo',
    '2951': 'Sólo enviar información para el tipos de servicios públicos 1 o 2',
    '2952': 'El valor del Tag no cumple con el tipo y longitud esperada', '2953': 'Es obligatorio indicar la unidad de medida del ítem',
    ...
    '2965': 'La sumatoria de otros tributos no corresponde al total', '2966': 'Sólo se puede indicar el códigos 55 del catálogo 53',
    ...
    '2976': 'El valor para el ajuste por redondeo no es válido', '2977': 'El valor de la moneda del Ajuste por redondeo debe ser PEN',
    ...
    '3001': 'El Código producto de SUNAT no puede ser vacio si es de Exportacion', '3002': 'El Código producto de SUNAT  no es válido',
    ...
    '3023': 'El tipo de documento no se encuentra en el catálogo', '3024': 'El tag cac:TaxTotal no debe repetirse a nivel de totales',
    '3025': 'El dato ingresado en factor de cargo o descuento global no cumple con el formato establecido.',
    '3026': 'El tag cac:TaxTotal no debe repetirse a nivel de Item', '3027': 'El valor del atributo no se encuentra en el catálogo',
    ...
    '3067': 'El código de tributo no debe repetirse a nivel de item', '3068': 'El código de tributo no debe repetirse a nivel de totales',
    ...
    '3140': 'El XML no contiene el tag de codigo del pais de residencia.', '3141': 'El XML no contiene el tag de fecha de ingreso del pais.',
    '3142': 'El XML no contiene el tag de fecha de ingreso al establecimiento.',
    '3143': 'El XML no contiene el tag de fecha de salida del establecimiento.', '3144': 'El XML no contiene el tag de fecha de consumo.',
    ...
    '3200': 'El tipo de estructura GS1 no tiene un valor permitido', '3201': 'El código de producto GS1 no cumple el estandar',
    '3202': 'El numero de RUC del receptor no existe.', '3203': 'El tipo de nota es un dato único',
    ...
    '3222': 'No existe información a nivel global de un tributo informado en la línea', '3223': 'La combinación de tributos no es permitida',
    ...
    '3239': 'El código de local anexo consignado no se encuentra declarado en el RUC', '3240': 'El impuesto ICBPER no aplica para el NRUS',
    '4000': 'El documento ya fue presentado anteriormente.', '4001': 'El numero de RUC del receptor no existe.',
    ...
    '4004': 'El DocumentTypeCode de las guias debe existir y tener 2 posiciones', '4005': 'El DocumentTypeCode de las guias debe ser 09 o 31',
    '4006': 'El ID de las guias debe tener informacion de la SERIE-NUMERO de guia.', '4007': 'El XML no contiene el ID de las guias.',
    ...
    '4013': 'El RUC  del receptor no esta activo', '4014': 'El RUC del receptor no esta habido',
    ...
    '4019': 'El calculo del IGV no es correcto', '4020': 'El ISC no esta informado correctamente',
    ...
    '4034': 'El comprobante fue registrado previamente como baja', '4035': 'El comprobante fue registrado previamente como rechazado',
    ...
    '4040': 'Si el importe de percepcion es mayor a 0.00, debe utilizar una leyenda con codigo 2000', '4041': 'El codigo de pais debe ser PE',
    ...
    '4049': 'El numero de DNI del receptor no existe.', '4050': 'El numero de RUC del proveedor no existe.',
    '4051': 'El RUC del proveedor no esta activo.', '4052': 'El RUC del proveedor no esta habido.',
    '4053': 'Proveedor no debe ser igual al remitente o destinatario.', '4054': 'La guía no debe contener datos del proveedor.',
    ...
    '4059': 'Numero de bultos o pallets - información válida para importación.', '4060': 'La guía no debe contener datos del transportista.',
    '4061': 'El numero de RUC del transportista no existe.', '4062': 'El RUC del transportista no esta activo.',
    ...
    '4157': 'No existe información en el tag datos de conductores.', '4158': 'No existe información en el tag datos de vehículos.',
    ...
    '4201': 'EL monto del ISC se debe detallar a nivel de línea', '4202': 'El valor ingresado como numero de DAM no cumple con el estandar',
    ...
    '4230': 'el Comprobante no debió ser observado.', '4231': 'El código de Ubigeo no existe en el listado.',
    ...
    '4234': 'El código de producto no cumple con el formato establecido', '4235': 'No existe información en el nombre del concepto.',
    ...
    '4252': 'El dato ingresado como atributo @listName es incorrecto.', '4253': 'El dato ingresado como atributo @listURI es incorrecto.',
    '4254': 'El dato ingresado como atributo @listID es incorrecto.', '4255': 'El dato ingresado como atributo @schemeName es incorrecto.',
    ...
    '4260': 'El dato ingresado como atributo @name es incorrecto.', '4261': 'El dato ingresado como atributo @listSchemeURI es incorrecto.',
    ...
    '4289': 'El valor de cargo/descuento por ítem difiere de los importes consignados.', '4290': 'El cálculo del IGV es Incorrecto',
    '4291': 'El dato ingresado como cargo/descuento no es valido a nivel global.',
    '4292': 'La Versión del UBL 2.0 se aceptará solo hasta el 30 de junio de 2019',
    ...
    '4303': 'La sumatoria del total valor de venta - ISC de línea no corresponden al total',
    '4304': 'La sumatoria del total valor de venta - Otros tributos de pago de línea no corresponden al total',
    ...
    '4316': 'La moneda del monto para el redondeo debe ser PEN', '4317': 'Debe consignar el Total Precio de Venta',
    ...
    '4334': 'El código de producto GS1 no cumple el estandar', '4335': 'El tipo de estructura GS1 no tiene un valor permitido',
