...
class PleReportPurchase(models.Model):
    ...
    def action_generate_excel(self):
        query = """
            ...
            COALESCE(ROUND(am.invoice_currency_rate, 3),'0.00')AS currency_rate,
            ...
            CASE WHEN am.bool_pay_invoice THEN '1' ELSE ' ' END AS type_pay,
            COALESCE(code_aduana.code, '') AS sunat_origin_code,
            COALESCE(am.l10n_pe_detraction_number, '') AS voucher_number,
            COALESCE(TO_CHAR(am.l10n_pe_detraction_date, 'DD/MM/YYYY'), '') AS voucher_payment_date,
