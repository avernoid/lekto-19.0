...
class PleReportSale(models.Model):
    ...
    move_ids = fields.Many2many(
        ...
        help='Invoices included in this PLE report period.'
    )
    ...
    def action_generate_excel(self):
        query = """
                    ...
                    ROUND(CASE WHEN am.invoice_currency_rate > 0 THEN 1 / am.invoice_currency_rate ELSE 1 END, 3) AS currency_rate,
