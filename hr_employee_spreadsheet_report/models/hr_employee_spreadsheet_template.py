...
class HrEmployeeSpreadsheetTemplate(models.Model):
    _name = "hr.employee.spreadsheet.template"
    _description = "Employee Spreadsheet Template"

    name = fields.Char(required=True)
    spreadsheet_id = fields.Many2one("hr.employee.spreadsheet", ondelete="cascade")
    ...
    def action_create_spreadsheet(self):
        ...
        spreadsheet = self.env["hr.employee.spreadsheet"].create(vals)
