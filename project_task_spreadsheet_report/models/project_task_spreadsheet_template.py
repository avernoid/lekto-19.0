...
class ProjectTaskSpreadsheetTemplate(models.Model):
    _name = "project.task.spreadsheet.template"
    _description = "Project Task Spreadsheet Template"

    name = fields.Char(required=True)
    spreadsheet_id = fields.Many2one("project.task.spreadsheet", ondelete="cascade")
    ...
    def action_create_spreadsheet(self):
        ...
        spreadsheet = self.env["project.task.spreadsheet"].create(vals)
