...
class SaleOrderSpreadsheetTemplate(models.Model):
    _name = "sale.order.report.spreadsheet.template"
    _description = "Sale Order Spreadsheet Template"

    name = fields.Char(required=True)
    spreadsheet_id = fields.Many2one("sale.order.report.spreadsheet", ondelete="cascade")
    ...
    def action_create_spreadsheet(self):
        ...
        spreadsheet = self.env["sale.order.report.spreadsheet"].create(vals)
