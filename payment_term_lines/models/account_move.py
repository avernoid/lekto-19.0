...
class AccountPaymentTermLine(models.Model):
    ...
    l10n_pe_is_detraction_retention = fields.Boolean(
        string='Is Detraction/Retention?',
        help='Check this box if this payment term line represents a detraction or retention that should be separated.'
    )

    delay_type = fields.Selection(
        selection_add=[('days_after_accounting_date', 'Days after accounting date')],
...
class AccountMoveLine(models.Model):
    ...
    tmp_date_maturity = fields.Date(
        string='Temporary Maturity Date',
        help='Technical field used to prevent automatic grouping of payment lines that share the same maturity date.'
    )
    l10n_pe_is_detraction_retention = fields.Boolean(
        string='Is Detraction/Retention?',
        help='Check this box if this payment term line represents a detraction or retention.'
    )
